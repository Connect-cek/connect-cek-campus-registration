        ...
        <div className="min-h-screen bg-[#F8EDE8] flex flex-col items-center p-6">
            ...
            {step === 1 && (
                <div className="bg-white shadow-lg rounded-xl p-10 w-full max-w-2xl">
                    ...
                    <form className="space-y-5">
                        <div><label className="block text-sm font-medium">Name of Institute</label><input type="text" className="w-full border rounded p-3" /></div>
                        <div><label className="block text-sm font-medium">Type of Institute <span className="text-gray-500">(private, government)</span></label><input type="text" className="w-full border rounded p-3" /></div>
                        <div><label className="block text-sm font-medium">Location</label><input type="text" className="w-full border rounded p-3" /></div>
                        <div><label className="block text-sm font-medium">Founded In</label><input type="text" className="w-full border rounded p-3" /></div>
                        <div><label className="block text-sm font-medium">Name of Head of Institute</label><input type="text" className="w-full border rounded p-3" /></div>
                        <div><label className="block text-sm font-medium">Designation of Head of Institute</label><input type="text" className="w-full border rounded p-3" /></div>
            ...
            {step === 2 && (
                <div className="flex flex-col items-center w-full max-w-4xl mx-auto p-6">
                    ...
                    <button className="bg-blue-500 text-white px-8 py-3 text-lg rounded-full mt-8 hover:bg-blue-600 transition-colors">
                        PROCEED
                    </button>
                </div>
            )}
